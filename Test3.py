...
class Test3:
    ...
    def draw_random_figures(self, num_figures=5):
        ...
        for _ in range(num_figures):
            ...
            if shape_type == "rect":
                self.shapes.append({"type": "rect", "color": color, "x": x, "y": y, "size": size})
                pygame.draw.rect(self.screen, color, (x, y, size, size))
            elif shape_type == "circle":
                self.shapes.append({"type": "circle", "color": color, "x": x, "y": y, "size": size})
    ...
    def run_level(self, level, num_figures=5):
        ...
        instruction_text = f"Click on the {target['type']} with color {target['color']}."
